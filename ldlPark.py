...
predictionsKNN = knn.predict(test_hog_pca);
...
#SVN
svc_classifier = SVC(kernel="rbf"); #possibility: kernel{‘linear’, ‘poly’, ‘rbf’, ‘sigmoid’, ‘precomputed’} or callable, default=’rbf’ ( radial basis function kernel)
